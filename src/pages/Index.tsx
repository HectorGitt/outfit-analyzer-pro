...
import { Camera, Upload, Sparkles, Star, Users, TrendingUp, ArrowRight, Zap, Shield, Globe } from "lucide-react"
...
const Index = () => {
  const features = [
    {
      ...
      description: "Upload your outfit photos for instant AI-powered fashion analysis",
      href: "/upload"
    },
    {
  ...
  const stats = [
    ...
    { icon: <Star className="w-5 h-5" />, label: "Accuracy Rate", value: "95%" },
    { icon: <Zap className="w-5 h-5" />, label: "Analyses Done", value: "1M+" },
    { icon: <Globe className="w-5 h-5" />, label: "Countries", value: "120+" }
  ]
            ...
            <div className="space-y-8 animate-fade-up">
              <div className="space-y-4">
                ...
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  ...
                  <span className="text-gradient">AI Fashion Intelligence</span>
                </h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Get instant, personalized fashion analysis and style recommendations 
                  powered by advanced AI technology. Perfect your look, boost your confidence.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-up">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to analyze, understand, and improve your fashion choices
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="card-fashion group hover:shadow-fashion transition-all duration-300">
                <CardHeader>
      ...
      <section className="py-20 bg-gradient-secondary">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">How FashCheck Works</h2>
            <p className="text-xl text-muted-foreground">Simple steps to perfect style</p>
          </div>
            ...
            {[
              {
                ...
                description: "Take a photo or upload an image of your outfit"
              },
              {
                step: "2", 
                title: "AI Analysis",
                description: "Our AI analyzes colors, style, and overall coherence"
              },
              {
                step: "3",
                title: "Get Insights",
                description: "Receive personalized recommendations and style tips"
              }
            ].map((step, index) => (
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl opacity-90">
              Join thousands of users who have elevated their fashion game with FashCheck
            </p>
