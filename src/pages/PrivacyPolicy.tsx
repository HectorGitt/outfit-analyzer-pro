				...
				<Card className="card-fashion">
					<CardContent className="prose max-w-none p-8">
						...
						<div className="privacy-section">
							...
							<ul>
								...
								<li>
									...
									means ownership of 50% or more of the
								...
								<li>
									...
									this Agreement) refers to closetic ai.
								</li>
								<li>
								...
								<li>
									<strong>Website</strong> refers to closetic
									ai, accessible from{" "}
									<a
										href="https://closetic.com"
						...
						<div className="privacy-section">
							...
							<ul>
								<li>By email: admin@closetic.com</li>
							</ul>
						</div>
					</CardContent>
				</Card>
